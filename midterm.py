...
def main():
    ...
    all_dataset = dataset.get_test_data_set(name)
    ...
    def generate_mean_response_cont_m(data_table, col_names, var_dict, response_name):
        mean_res_ranking = {}
        mean_res_ranking_w = {}
        plots = []
        for i in col_names:
    ...
    def generate_html_m(data_table, col_names, var_dict, response_name):  # noqa:
        if var_dict[response_name] == "Boolean":
            ...
            mean_r, w, u = generate_mean_response_cont_m(
                dataset_table, predictors, cat_dic, response_var
            )
    ...
    def bf_cont_cont(data_table, response_name, corr_p_t):
        ...
        for cont_1, cont_2 in zip(
            ...
            text = np.zeros((len(bins2), len(bins_2_2)), dtype="U20")
            cont_cont_diff_mean = []
    ...
    (
        ...
        rf_imp_table,
        plots_table,
    ) = generate_html_m(dataset_table, predictors, cat_dic, response_var)
    ...
    cat_c_tab, cat_t_tab, cat_c_fig, cat_t_fig = cat_cat_matrix(
        dataset_table, predictors, cat_dic, plot_dic, plot_mr_dic
    )
    ...
    bf_cat_cat_table = bf_cat_cat(dataset_table, response_var, cat_c_tab, cat_t_tab)

    bf_cat_cont_table = bf_cat_cont(dataset_table, response_var, cat_cont_tab)

    bf_cont_cont_table = bf_cont_cont(dataset_table, response_var, cont_cont_tab)
    ...
    with open("midterm.html", "w") as file:
